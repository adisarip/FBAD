...
int main(int argc, char *argv[])
{
    ...
    // binary image - Integral Image
    cv::Mat at_out = cv::Mat::zeros(gray.size(), CV_8UC1);
    thresholdIntegral(gray, at_out);
    cv::imshow("at_image", at_out);
    cv::imwrite("at_image.jpg", at_out);
